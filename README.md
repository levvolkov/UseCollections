...
4. Закоммитьте и запушьте созданный проект на гитхаб, [настройте Github Actions](https://github.com/netology-code/javaqa-homeworks-video/blob/javaqa-55/QA_CI.md), сделайте `git pull`.
